...
// Source of MoiraiDelegate.sol — embedded for collapsible display in the brutalist preview.
// Keep in sync with: account-policies/src/policies/MoiraiDelegate.sol

export const MOIRAI_DELEGATE_SOURCE = `// SPDX-License-Identifier: MIT
